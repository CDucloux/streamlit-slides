...
Et c'est là que *Streamlit* arrive avec une idée toute simple.
...
On peut ajouter des colonnes, créer des boites flexbox avec les container, des tabs, une sidebar, etc.
